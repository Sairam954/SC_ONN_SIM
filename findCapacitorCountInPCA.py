...
metrics = Metrics()
amm_1 = metrics.get_total_area('AMM',1, 31, 31,'ANALOG')
amm_5 = metrics.get_total_area('AMM',1, 16, 16,'ANALOG')
amm_10 = metrics.get_total_area('AMM',1, 12, 12,'ANALOG')
mam_1 = metrics.get_total_area('MAM',1, 44, 44,'ANALOG')
mam_5 = metrics.get_total_area('MAM',1, 22, 22,'ANALOG')
mam_10 = metrics.get_total_area('MAM',1, 16, 16,'ANALOG')
mma_1 = metrics.get_total_area('MMA',1, 83, 83,'ANALOG')
mma_5 = metrics.get_total_area('MMA',1, 42, 42,'ANALOG')
mma_10 = metrics.get_total_area('MMA',1, 31, 31,'ANALOG')
print('AMM 1', mma_1/amm_1)
print('AMM 5', mma_1/amm_5)
print('AMM 10', mma_1/amm_10)
print('MAM 1', mma_1/mam_1)
print('MAM 5', mma_1/mam_5)
print('MAM 10', mma_1/mam_10)
print('MMA 1', mma_1/mma_1)
print('MMA 5', mma_1/mma_5)
print('MMA 10', mma_1/mma_10)

# print('AMM', metrics.get_total_area('AMM',1, 31, 31,'ANALOG'))
# print('AMM', metrics.get_total_area('AMM',1, 16, 16,'ANALOG'))
# print('AMM', metrics.get_total_area('AMM',1, 12, 12,'ANALOG'))
# print('MAM', metrics.get_total_area('MAM',1, 44, 44,'ANALOG'))
# print('MAM', metrics.get_total_area('MAM',1, 22, 22,'ANALOG'))
# print('MAM', metrics.get_total_area('MAM',1, 16, 16,'ANALOG'))
# print('MMA', metrics.get_total_area('MMA',1, 83, 83,'ANALOG'))
# print('MMA', metrics.get_total_area('MMA',1, 42, 42,'ANALOG'))
# print('MMA', metrics.get_total_area('MMA',1, 31, 31,'ANALOG'))
