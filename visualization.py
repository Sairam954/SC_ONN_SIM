...
ax3 = sns.lineplot(data=result_df_MAM,x='N', y = 'Sum of Products Supported Precision', hue='SOMA (dBm)', linestyle='--', palette=sns.color_palette('bright', n_colors=3), legend= False)
